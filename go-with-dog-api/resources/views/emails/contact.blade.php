                        ...
                        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                                <td style="padding:0 35px;">
                                    <h1 style="color:#7BABD8; font-weight:500; margin:0;font-size:32px;font-family:'Rubik',sans-serif;">Bonjour
                                    </h1>
                                    ...
                                    <p
                                        style="color:#455056; font-size:18px;line-height:20px; margin:0; font-weight: 500;">
                                        <strong
                                            style="display: block; font-size: 13px; margin: 24px 0 4px 0; font-weight:normal; color:rgba(0,0,0,.64);">Sujet</strong><span style="color: #44455f;">{{ $subject }}</span>
                                    </p>
                                    <p
                                        style="color:#455056; font-size:18px;line-height:20px; margin:0; font-weight: 500;">
                                        <strong
                                            style="display: block; font-size: 13px; margin: 24px 0 4px 0; font-weight:normal; color:rgba(0,0,0,.64);">Message</strong><span style="color: #44455f;">{{ $contenu }}</span>
                                    </p>
